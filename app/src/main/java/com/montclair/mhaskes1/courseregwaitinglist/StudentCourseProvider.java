package com.montclair.mhaskes1.courseregwaitinglist;
...
public class StudentCourseProvider extends ContentProvider {
     ...
     */
    private static final String AUTHORITY = "com.montclair.mhaskes1.courseregwaitinglist.StudentCourseProvider";
    /**
    ...
    /**
     * STUDENT means give me the data and STUDENT ID MEANS one single row
     */
